    ...
    return ( 
        <div className='container '>
            <div className='row text-center mb-5'>
                <h2 style={{lineHeight:"53px",color:"#424242",margin:"65px 0 65px 0"}}>We pioneered the discount broking model in India.<br/>
                Now, we are breaking ground with our technology.</h2>
                
            </div>
            <div className='row border-top mx-5 p-5' style={{color:"#424242"}}>
                <div className='col-6' style={{marginTop:"70px", lineHeight:"30px"}}>
